<?php
/* 
Template Name: Results - Food Grade Air
*/
...
$QuestionNo = '1'; $Answer = 'D'; $Minutes = '1'; $Seconds = '12';
$Question = 'Compressed air used in the food and beverage industry may contaminate the final product with:';
$E02_Q01 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '2'; $Answer = 'C'; $Minutes = '3'; $Seconds = '55';
$Question = 'The BCAS <em>Food and Beverage Grade Compressed Air: Best Practice Guideline 102</em> includes purity limits for:';
$E02_Q02 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '3'; $Answer = 'B'; $Minutes = '5'; $Seconds = '54';
$Question = 'According to the BCAS Guideline, what is the minimum recommendation for testing compressed air quality?';
$E02_Q03 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '4'; $Answer = 'B'; $Minutes = '6'; $Seconds = '09';
$Question = 'The risk for microbiological contaminants should be assessed per which reference document?';
$E02_Q04 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '5'; $Answer = 'A'; $Minutes = '9'; $Seconds = '10';
$Question = 'Which of the following include primary sources of contamination of compressed air?';
$E02_Q05 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '6'; $Answer = 'D'; $Minutes = '10'; $Seconds = '48';
...
$E02_Q06 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-food-and-beverage-industry/">Find the answer</a>');

$QuestionNo = '7'; $Answer = 'B'; $Minutes = '12'; $Seconds = '50';
$Question = 'Indirect contact of compressed air in packaging may include blow molding, surface cleaning, and:';
$E02_Q07 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/food-packaging-compressed-air-quality/">Find the answer</a>');

$QuestionNo = '8'; $Answer = 'D'; $Minutes = '15'; $Seconds = '28';
...
$E02_Q08 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/air-quality-specifications/">Find the answer</a>');

$QuestionNo = '9'; $Answer = 'A'; $Minutes = '14'; $Seconds = '46';
$Question = 'According to the BCAS Guideline, compressed air that falls under the indirect contact category shall meet:';
$E02_Q09 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/air-quality-specifications/">Find the answer</a>');

$QuestionNo = '10'; $Answer = 'C'; $Minutes = '2'; $Seconds = '39';
$Question = 'The pet food industry is regulated by which of the following organizations?';
$E02_Q10 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-pet-food-industry/">Find the answer</a>');

$QuestionNo = '11'; $Answer = 'C'; $Minutes = '2'; $Seconds = '39';
$Question = 'According to the BCAS, the maximum number of particles per m³ for .01-.05 micron should be:';
$E02_Q11 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-pet-food-industry/">Find the answer</a>');

$QuestionNo = '12'; $Answer = 'B'; $Minutes = '2'; $Seconds = '39';
$Question = 'Which of the following states the maximum number of particles per m<sup>3</sup> for 0.5-1.0 micron, according to the BCAS?';
$E02_Q12 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/food-grade-air-in-manufacturing/compressed-air-in-the-pet-food-industry/">Find the answer</a>');
...
/*
 		echo "$question is incorrect<br>";
 		echo "Your answer was $guess<br>";
*/
		$incorrect[] = $question;
		}
	}
...
//// build the PDF
	...
	if(!file_exists($pdfFolder.$pdfName)) {
		...
		$pdf->SetY(4.55);
		$pdf->SetFont('Arial Narrow Italic','',18);
		$pdf->Cell(10,.5,'provided by Trace Analtyics, LLC in Austin, Texas:',0,0,'C');
