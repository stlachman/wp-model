<?php
/* 
Template Name: Results - Sources of Contamination
*/
...
$Question = 'What are the two primary sources of contamination in a compressed air system?';
$E02_Q01 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q1">Find the answer</a>');

$QuestionNo = '2'; $Answer = 'D'; $Minutes = '8'; $Seconds = '25';
...
$E02_Q02 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q1">Find the answer</a>');

$QuestionNo = '3'; $Answer = 'B'; $Minutes = '3'; $Seconds = '55';
$Question = 'What contaminants may be created by the compressor system?';
$E02_Q03 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q3">Find the answer</a>');

$QuestionNo = '4'; $Answer = 'D'; $Minutes = '5'; $Seconds = '54';
$Question = 'Which of the following gases may be produced by compressors?';
$E02_Q04 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q3">Find the answer</a>');

$QuestionNo = '5'; $Answer = 'D'; $Minutes = '6'; $Seconds = '09';
$Question = 'Why is it important to test new piping for use with compressed air systems?';
$E02_Q05 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q5">Find the answer</a>');
...
$E02_Q06 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q5">Find the answer</a>');
...
$E02_Q07 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/sources-of-contamination-in-manufacturing/#q7">Find the answer</a>');

$QuestionNo = '8'; $Answer = 'D'; $Minutes = '10'; $Seconds = '48';
$Question = 'According to Parker Balston, how many points of use should be considered Risk Point(s) and tested?';
$E02_Q08 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 2 of the "Reducing Contamination Risks" PDF</a>');
...
$E02_Q09 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 3 of the "Reducing Contamination Risks" PDF</a>');
...
$E02_Q10 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 3 of the "Reducing Contamination Risks" PDF</a>');
...
$E02_Q11 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 3 of the "Reducing Contamination Risks" PDF</a>');

$QuestionNo = '12'; $Answer = 'C'; $Minutes = '14'; $Seconds = '46';
...
$E02_Q12 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 6 of the "Reducing Contamination Risks" PDF</a>');
...
$E02_Q13 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 7 of the "Reducing Contamination Risks" PDF</a>');

$QuestionNo = '14'; $Answer = 'D'; $Minutes = '2'; $Seconds = '39';
$Question = 'Which standard does Parker Balston reference for microbiological testing?';
$E02_Q14 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 7 of the "Reducing Contamination Risks" PDF</a>');

$QuestionNo = '15'; $Answer = 'B'; $Minutes = '2'; $Seconds = '39';
...
$E02_Q15 = array($Answer, '<strong>Question '.$QuestionNo.'</strong> - '.$Question.' <a title="'.$Question.'" target="blank" href="https://www.airchecklab.com/aircheck-academy/compressed-air-in-the-food-industry/sources-of-contamination/reducing-contamination-risks/">See Page 7 of the "Reducing Contamination Risks" PDF</a>');
...
<div class="eleven columns center mart20">
	<h1>Congratulations, {$FirstName}!</h1>
