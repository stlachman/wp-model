<?php
/* 
Template Name: Process Academy Contact
*/
...
/* 	$IPAddress = $_SERVER['HTTP_X_FORWARDED_FOR']; */
	...
	*/
		...
		if (isset($_POST['ReferringPage'])) { $inPage.="		<div class='three columns'><strong>Referring Page:</strong> </div><div class='six columns padl10'>" . $ReferringPage . "</div><div class='clearfix'></div>\n"; }
		if (isset($_POST['BugDescription'])) { 
