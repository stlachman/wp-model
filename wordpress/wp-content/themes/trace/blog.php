...
<?php if ( is_404() ) { ?>
	<div class="center">
		...
		<p>We're very sorry, it appears that this page either doesn't exist, or isn't functioning properly.<br />
		Want us to fix this problem? Help us out by <a href="/report-a-bug">Reporting a Bug DOES NOT WORK YET</a>.</p>
	</div>
<?php	}
?>
	...
	<?php if(have_posts()) : while(have_posts()) : the_post();
		...
		if(isset($postcustoms["averis_post_type"]))
			switch ($postcustoms["averis_post_type"]) {
				...
				case 'audio':
					$post_top = '<audio id="player3" src="'.$postcustoms["averis_audio_link"].'" controls="controls"></audio>';
				break;
