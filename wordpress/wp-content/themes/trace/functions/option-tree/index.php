...
define( 'OT_PLUGIN_DIR', get_template_directory() . '/functions/option-tree');
define( 'OT_PLUGIN_URL', get_template_directory_uri() . '/functions/option-tree');
...
add_action( 'wp_ajax_option_tree_add_slider2', array( $ot_admin, 'option_tree_add_slider2' ) );
