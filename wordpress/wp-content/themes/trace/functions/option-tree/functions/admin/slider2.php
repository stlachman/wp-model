 ...
 * @return string
 */
function option_tree_slider2( $value, $settings, $int ) 
{ 
?>
  <div class="option option-option-tree-slider">
    ...
    <div class="section">
      <div class="element">
        ...
        <a href="#" id="<?php echo $value->item_id; ?>" class="button-framework light add-slide right">Add Slidy</a>
      </div>
 ...
 * @return string
 */
function option_tree_slider_view2( $id, $image, $int, $count ) {
  // required fileds
  ...
  <div id="option-tree-slider-editor_<?php echo $count; ?>" class="option-tree-slider">
    <div class="open">
      <?php echo empty( $image['title'] ) ? "2con " . ($count + 1) : stripslashes($image['title']); ?>
    </div>
